import { ResourceManager } from 'minecraft-resource-manager';
...
export declare const DEFAULT_DISPLAY: Display;
export declare const BUILTIN_GENERATED: ResolvedModel;
export declare class BakedModel extends THREE.Object3D {
    animationLoop: boolean;
    displayOption: Display;
    applyDisplay(option: string): void;
    getCenter(): THREE.Vector3;
}
export declare class ThreeModelLoader {
    readonly manager: ResourceManager;
    readonly option: {
        clipUVs?: boolean;
        modelOnly?: boolean;
    };
    constructor(manager: ResourceManager, option?: {
        clipUVs?: boolean;
        modelOnly?: boolean;
    });
    resolveModel(modelPath: string): Promise<ResolvedModel | undefined>;
    bakeModel(model: ResolvedModel): Promise<BakedModel>;
    load(path: string): Promise<BakedModel | undefined>;
}
